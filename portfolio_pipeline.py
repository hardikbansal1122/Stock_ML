...
"""Single orchestration layer for the Stock ML project.

This module encapsulates the end‑to‑end back‑testing flow that was previously
duplicated in ``step4_backtest.py`` and partially in ``unified_eval.py``.
It provides a singleton ``PortfolioEngine`` instance and a ``run_pipeline``
function that can be used as a thin entry‑point from any script.
"""
...
# ----------------------------------------------------------------------------
# Helper utilities (mirrored from step4_backtest.py)
# ----------------------------------------------------------------------------
